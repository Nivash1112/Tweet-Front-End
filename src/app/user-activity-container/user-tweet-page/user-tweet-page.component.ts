...
@Component({
  selector: 'app-user-tweet-page',
  templateUrl: './user-tweet-page.component.html',
  styleUrls: ['./user-tweet-page.component.css']
})
export class UserTweetPageComponent implements OnInit {
